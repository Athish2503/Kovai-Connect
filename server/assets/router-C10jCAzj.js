...
const appCss = "/kovai-connect/assets/styles-DUWtqecD.css";
...
const $$splitComponentImporter$2 = () => import("./index-6K7K9K24.js");
const Route$2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "A localized business directory & digital marketing platform for Coimbatore's home entrepreneurs, professionals, startups and retail shops."
    }, {
      property: "og:title",
      content: "KovaiConnect — Coimbatore's Local Business Directory"
    }, {
      property: "og:description",
      content: "Discover trusted bakers, doctors, tailors, startups and more across Kovai."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./businesses.index-BkkoCWfy.js");
const Route$1 = createFileRoute("/businesses/")({
  validateSearch: (s) => ({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Search and filter verified bakers, doctors, tailors, startups and more across Coimbatore."
    }]
  }),
...
const businesses = [
  {
    ...
    about: "A home-grown bakery in the heart of RS Puram, run by chef Anitha. Every loaf is naturally fermented for 24 hours and every cake is made to order with locally sourced ingredients.",
  ...
  },
  {
    ...
    about: "Dr. Meera has been serving Saibaba Colony families for over 15 years, with a focus on preventive care, paediatrics, and women's health.",
  ...
  },
  {
    ...
    about: "A boutique legal practice handling property disputes, MSME contracts, and family matters across Tamil Nadu courts.",
  ...
  },
  {
    ...
    about: "Three generations of tailors serving Gandhipuram. Specialists in bridal blouses, kurtas, and alterations with 48-hour turnaround.",
  ...
  },
  {
    ...
    about: "Neighbourhood grocer offering organic vegetables, millets, and pantry staples with same-day delivery within 5 km.",
  ...
  },
  {
    ...
    about: "A SaaS startup helping textile exporters automate dispatch and tracking. YC-backed, hiring across engineering and design.",
  ...
  },
  {
    ...
    about: "Award-winning practice designing courtyard homes, weekend villas, and adaptive reuse projects across Kongu region.",
  ...
  },
  {
    ...
    about: "Trusted by 400+ Coimbatore MSMEs for tax filings, audits, and business advisory. Transparent pricing, monthly reports.",
...
const $$splitComponentImporter = () => import("./businesses._id-DBU1pVZa.js");
const $$splitErrorComponentImporter = () => import("./businesses._id-CZiFTl3j.js");
const $$splitNotFoundComponentImporter = () => import("./businesses._id-BFHt3mrt.js");
const Route2 = createFileRoute("/businesses/$id")({
  loader: ({
    params
  }) => {
...
const BusinessesIndexRoute = Route$1.update({
  id: "/businesses/",
  path: "/businesses/",
  getParentRoute: () => Route$3
});
const BusinessesIdRoute = Route2.update({
  id: "/businesses/$id",
  path: "/businesses/$id",
  getParentRoute: () => Route$3
});
