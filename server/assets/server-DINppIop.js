...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-CXkr4seZ.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C10jCAzj.js").then((n2) => n2.r),
    import("./start-CLZ1VNTI.js"),
...
var ROUTER_BASEPATH = "kovai-connect";
var SERVER_FN_BASE = "/kovai-connect/_serverFn/";
